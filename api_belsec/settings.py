"""
Django settings for api_belsec project.
...
SECRET_KEY = 'django-insecure-t49^$f@t*d4nqs8u*=0=_j71gcd)y0o%6hn&-wn#n&a*+_8+eh'
...
WSGI_APPLICATION = 'api_belsec.wsgi.application'
...
# Defina o diretório onde os arquivos de mídia serão armazenados
